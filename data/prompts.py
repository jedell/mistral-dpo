...
generate_intro = """You are tasked with generating data samples based on the following criteria and examples:"""

system = intro + format_instructions + functions + fields_prompt + fields + types_prompt + types

generate_prompt = generate_intro + format_instructions + functions